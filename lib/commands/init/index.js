...
module.exports = async (args, options, logger) => {
    logger.info(
        "\n" +
        chalk.bgGreen.white("Hello ! Jean-Patrice Kéka here, ready to kickstart your app !")
    );
    ...
    logger.info(
        "\n" +
        chalk.blue("🚀 Finally, i'm gonna install your dependencies. Cause nobody can launch a rocket without help !")
    );
    ...
    try {
        ...
        logger.error("Sorry mate, there was an error during the installation of your dependencies. Check npm-debug.log.");
        logger.debug(error);
        return;
    }

    logger.info(chalk.green("✓ Pfew, it was not easy to gather all these forces !"));
    ...
    logger.info(
        "\n" +
        chalk.italic("\"C'est un petit pas pour l'homme, mais un grand pas pour la République Démocratique du Congo\"") +
        "\n" +
        "    - Jean-Patrice Kéka"
    );
};
